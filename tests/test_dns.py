...
import base64
import json
from dmp.core.dns import (
    DMPDNSRecord, DNSEncoder, DNSOperations, DNSChunkManager
)
...
class TestDNSEncoder:
    ...
    def test_encode_identity_domain(self):
        ...
        domain = DNSEncoder.encode_identity_domain(
            'alice',
            'mesh.example.com'
        )
        ...
        domain2 = DNSEncoder.encode_identity_domain(
            'alice',
            'mesh.example.com'
        )
    ...
    def test_encode_mailbox_domain(self):
        ...
        user_id = b'U' * 32
        domain = DNSEncoder.encode_mailbox_domain(
            user_id,
            5,
            'mesh.example.com'
        )
    ...
    def test_validate_domain(self):
        ...
        assert not DNSEncoder.validate_domain('label-' + 'a' * 60 + '.com')  # Label too long
...
class TestDNSChunkManager:
    ...
    def test_chunk_storage_retrieval(self):
        ...
        # Retrieve the chunk
        retrieved = manager.retrieve_chunk(
            message_id,
            0,
            'mesh.com'
        )
        ...
        missing = manager.retrieve_chunk(
            message_id,
            999,
            'mesh.com'
        )
    ...
    def test_retrieve_all_chunks(self):
        ...
        # Retrieve all chunks
        retrieved = manager.retrieve_all_chunks(
            message_id,
            3,
            'mesh.com'
        )
