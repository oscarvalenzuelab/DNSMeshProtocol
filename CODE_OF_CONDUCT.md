...
The DNS Mesh Protocol (DMP) project is committed to providing a
welcoming and productive environment for everyone who participates,
regardless of background or experience level. This Code of Conduct
sets the standard for how project participants — contributors,
maintainers, operators, and users — interact in project spaces.
...
on the project and on each other.
...
abuses of power that exist in society. If you see someone who is
making an extra effort to ensure our community is welcoming,
friendly, and encourages all participants to contribute to the
fullest extent, recognize that effort.

## Expected behavior

The following behaviors are expected and requested of all project
participants:

- Be considerate, respectful, and collaborative.
- Refrain from demeaning, discriminatory, or harassing behavior
  and speech.
- Be mindful of your fellow participants. Alert maintainers if you
  notice a dangerous situation, someone in distress, or violations
  of this Code of Conduct, even if they seem inconsequential.
- Participate in an authentic and active way. In doing so, you
  contribute to the health and longevity of this project.
...
other concerns, please notify the project maintainers by opening a
GitHub issue or, for sensitive matters, using
[GitHub's private vulnerability reporting](https://github.com/oscarvalenzuelab/DNSMeshProtocol/security/advisories/new)
feature so the report stays confidential while it's investigated.
...
Conduct, the project maintainers may take any action they deem
appropriate, up to and including a temporary ban or permanent
expulsion from the community without warning (and without refund in
the case of a paid event, where applicable).

## Scope

This Code of Conduct applies to all project spaces, including the
GitHub repository, issue tracker, pull requests, discussions, and
any other forum or event organized under the project's banner.
