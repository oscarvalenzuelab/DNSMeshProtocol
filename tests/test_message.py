...
class TestDMPHeader:
    ...
    def test_header_expiration(self):
        ...
        expired = DMPHeader(timestamp=int(time.time()) - 400, ttl=300)
    ...
    def test_chunk_id_generation(self):
        ...
        header = DMPHeader(message_id=b"\x01" * 16, chunk_number=42)
...
class TestDMPMessage:
    ...
    def test_invalid_message_deserialization(self):
        ...
        with pytest.raises(ValueError, match="incomplete"):
            DMPMessage.from_bytes(
                b"\x00\x10" + b"A" * 40
            )  # 2 + 40 = 42 bytes, but needs 2 + 16 + 32 = 50

    def test_message_hash(self):
        """Test message hash calculation"""
        msg = DMPMessage(payload=b"Test payload")
...
class TestDMPIdentity:
    ...
    def test_identity_creation(self):
        ...
        identity = DMPIdentity(username="alice", public_key=b"P" * 32)
    ...
    def test_user_id_generation(self):
        ...
        identity = DMPIdentity(username="bob", public_key=b"K" * 32)
